        ...
        >
          ...
          >
            ...
            {exclusionModal.parameters && exclusionModal.parameters.length > 0 && (
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Flagged Parameters</p>
                <div className="space-y-2">
                  {exclusionModal.parameters.map((param, idx) => (
                    <div key={idx} className="flex items-center justify-between bg-orange-50 border border-orange-200 rounded-lg px-3 py-2">
                      ...
                      <span className="text-sm font-bold text-orange-700">{param.value}</span>
                    </div>
                  ))}
                </div>
              </div>
